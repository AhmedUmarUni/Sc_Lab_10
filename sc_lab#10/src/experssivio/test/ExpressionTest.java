...
public class ExpressionTest {
    ...
    @Test
    public void testMultipleExpressionsEqual() {
        Expression num1 = new Number(1);
        Expression num2 = new Number(1);
        Expression var1 = new Variable("x");
        Expression var2 = new Variable("x");
        Expression add1 = new Addition(num1, var1);
        Expression add2 = new Addition(num2, var2);
        
        Expression mul1 = new Multiplication(add1, var1);
        Expression mul2 = new Multiplication(add2, var2);

        assertEquals(mul1, mul2);  // Nested equality tests
